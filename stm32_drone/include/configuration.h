...
#define AUTOLEVEL_MODE_ENABLED true
#define AUTOLEVEL_MODE_CHANNEL ch6
#define AUTOLEVEL_ENABLE_RANGE_MIN 750
#define AUTOLEVEL_ENABLE_RANGE_MAX 1250

#define ACRO_MODE_ENABLED true
#define ACRO_MODE_CHANNEL ch6
#define ACRO_MODE_ENABLE_RANGE_MIN 1250
#define ACRO_MODE_ENABLE_RANGE_MAX 1750
